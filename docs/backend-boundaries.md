...
| In-app/local browser backend | Not implemented | Localhost or public unsigned pages where no signed-in Chrome state is needed. | Future optional backend. Current Formax should document that it only supports Chrome. |
