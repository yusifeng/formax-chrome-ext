...
describe("browser tool schemas", () => {
  ...
  it("keeps protocol docs action sections aligned with the shared action registry", () => {
    ...
    expect(packageJson.scripts).toMatchObject({
      "docs:protocol": "npm run build:runtime && node scripts/generate-protocol-action-reference.js",
      "check:protocol-sync": "npm run build:runtime && node scripts/generate-protocol-action-reference.js --check"
    });
